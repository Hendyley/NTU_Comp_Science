...
public class Connect extends AppCompatActivity {
    ...
    private static final String TAG = "MDPTAG Connect";
    ...
    public boolean connFLAG=false; //for bluetooth connection reconnect
    public boolean FconnFLAG=false; //for bluetooth fail connection
    public boolean CconnFLAG=false;
...
//                    scanNewDevices();
    ...
    BroadcastReceiver btConnectionReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (connectionStatus.equals("disconnect") && (connFLAG==false) ) {
...
//                //CHECK FOR NOT NULL
                ...
                Toast.makeText(Connect.this, "Disconnected From " + myBTConnectionDevice.getName(),
                        Toast.LENGTH_LONG).show();
                ...
                alertDialog.setMessage("Connection with device: '"+myBTConnectionDevice.getName()+"' has ended. Reconnecting.....");
...
//                alertDialog.show();
            ...
            else if (connectionStatus.equals("connect") && (CconnFLAG==false)) {
            ...
            else if (connectionStatus.equals("connectionFail")){// && (FconnFLAG==false)) {
            ...
            Log.d(TAG, "Receiving btConnectionStatus Msg!!! CconnFLAG connFLAG FconnFLAG : " + CconnFLAG+" "+connFLAG+" "+FconnFLAG);
...
//        LocalBroadcastManager.getInstance(this).unregisterReceiver(btConnectionReceiver);
    ...
    public boolean getCconnflag(){
        return this.CconnFLAG;
    }
    public boolean getconnflag(){
        return this.connFLAG;
    }
    public boolean getFconnflag(){
        return this.FconnFLAG;
    }

    public void setCconnFLAG(boolean b) {
        this.CconnFLAG = b;
    }

    public void setConnFLAG(boolean b) {
        this.connFLAG = b;
        Log.d(TAG,"connFLAG : "+connFLAG);
    }

    public void setFconnFLAG(boolean b) {
        this.FconnFLAG = b;
    }
}
