...
if (root->left!=NULL && root->item < root->left->item
    //&& root->item > root->left->left->item
    //&& root->item < root->left->right->item
    ){
    //printf("case 2\n");
    n=root->left->item;
...
else if (root->right!=NULL && root->item > root->right->item
         //&& root->item > root->right->left->item
         //&& root->item < root->right->right->item
         ){
    //printf("case 3\n");
    n=root->right->item;
...
else if (root->left!=NULL && root->right!=NULL && root->right->item < root->left->item ){
    //printf("case 1\n");
    n=root->left->item;
